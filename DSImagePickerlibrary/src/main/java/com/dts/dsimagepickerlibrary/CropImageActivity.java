...
import static com.dts.dsimagepickerlibrary.CropImage.REQUEST_WRITE_STORAGE;
...
public class CropImageActivity extends AppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      if (mCropImageUri == null || mCropImageUri.equals(Uri.EMPTY)) {
        ...
        CropImage.showDialogImageChooser(this);
 ...
 /* @Override
    ...
    if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE) {
      ...
      if (resultCode == Activity.RESULT_OK) {
        ...
        if (CropImage.isReadExternalStoragePermissionsRequired(this, mCropImageUri)) {
          ...
          if(!mCropImageUri.toString().contains("content")){
            Uri newUri = Uri.parse(String.valueOf(uri));
            mCropImageUri=newUri;
          ...
          mCropImageView.setImageUriAsync(mCropImageUri);
          Bundle b = getIntent().getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE);
          if (b!=null){
            b.putParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE,mCropImageUri);
            getIntent().putExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE, b);
          }
        }
      }
    }
  ...
  protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
    ...
    if (resultCode == Activity.RESULT_OK) {
      if (requestCode == CropImage.SELECT_IMAGE) {
      ...
      } else if (requestCode == CropImage.CAMERA_RESULT) {
        if (CropImage.mCapturedImageURI != null) {

          try {
//            cropSelectedImage(CropImage.mCapturedImageURI);

            mCropImageView.setImageUriAsync(CropImage.mCapturedImageURI);
            Bundle b = getIntent().getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE);
            if (b!=null){
              b.putParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE,mCropImageUri);
              getIntent().putExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE, b);
